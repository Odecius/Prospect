...
Este arquivo acompanha ações concretas próximas. A sequência de produto está em [ROADMAP.md](ROADMAP.md).
...
- [x] Validar build, healthchecks e conexão PostgreSQL do Docker Compose em ambiente com Docker.
- [x] Aprovar e implementar o escopo documental da Fase 1B.
- [x] Introduzir serviços e repositórios somente quando uma fase autorizada os exigir.
- [x] Definir critérios operacionais conservadores de duplicidade para a Sprint 3.
- [x] Definir a taxonomia inicial e sua governança.
- [x] Definir política conservadora de minimização e retenção; base legal definitiva permanece para validação jurídica.
- [x] Definir política de autenticação e primeiro usuário administrador.
- [x] Definir os campos mínimos do cadastro manual.
- [x] Definir os estados iniciais do funil e `NEW` como estado padrão.
- [x] Definir o término do produto interno na Fase 13.
- [x] Criar `.gitignore` seguro e `.env.example` sem segredos.
- [x] Preparar estrutura mínima FastAPI e Docker Compose.
- [x] Criar testes iniciais antes da primeira regra de negócio.
...
- [x] Consultadas as diretrizes oficiais da ABC Solutions.
- [x] Planejamento documental inicial criado.
- [x] Arquitetura monolítica modular proposta.
- [x] Modelo conceitual inicial documentado.
- [x] Aplicação futura do branding oficial definida.
- [x] Documentação principal revisada e aprovada como referência oficial.
- [x] Glossário, regras de negócio e matriz de rastreabilidade criados.
- [x] Plano de execução em sprints criado.
